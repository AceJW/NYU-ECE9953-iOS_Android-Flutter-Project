...
import 'package:nyu_advanced_project_1/widgets/icon_and_text.dart';
...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  Widget _buildPageItem(int index){
    ...
    if(index == _currPageValue.floor()){
      var currSacle = 1-(_currPageValue-index)*(1-_scaleFactor);
      var currTrans = _height*(1-currSacle)/2;
      matrix = Matrix4.diagonal3Values(1, currSacle, 1)..setTranslationRaw(0, currTrans, 0);
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    ...
                    blurRadius: 5.0, //lagre number => less blur
